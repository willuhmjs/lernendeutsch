...
<div class="legal-page">
	<div class="legal-card">
		<h1 class="dark:text-white">Terms of Service</h1>
		...
		<section>
			<h2 class="dark:text-white">1. Acceptance of Terms</h2>
			<p class="dark:text-slate-300">
				...
				between you and LingoLearn.
			</p>
		</section>

		<section>
			<h2 class="dark:text-white">2. Eligibility</h2>
			<p class="dark:text-slate-300">
		...
		<section>
			<h2 class="dark:text-white">4. Acceptable Use</h2>
		...
		<section>
			<h2 class="dark:text-white">14. Contact Us</h2>
			<p class="dark:text-slate-300">
