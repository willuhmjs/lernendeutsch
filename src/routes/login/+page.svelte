<script lang="ts">
	...
	$: errorMsg = form?.error || (urlError ? errorMessages[urlError] || urlError : '');
</script>
...
<div class="page-container">
	<div class="auth-card">
		...
		<div class="google-auth">
			<button class="google-btn dark:bg-slate-800 dark:text-white dark:border-slate-700" on:click={() => signIn('google', { callbackUrl: '/dashboard' })}>
