...
export async function runSeed(client: PrismaClient = prisma, override: boolean = false) {
	...
	console.log(
		`Seeded ${basicGrammarRules.length} German grammar rules, ${spanishGrammarRules.length} Spanish grammar rules, and ${frenchGrammarRules.length} French grammar rules.`
	);
